      ...
      try {
        if (searchAPI === 'searxng' && effectiveSearchDepth === 'advanced') {
          ...
          searchResult = await (searchAPI === 'tavily'
            ...
            filledQuery,
            max_results,
            effectiveSearchDepth === 'advanced' ? 'advanced' : 'advanced',
            include_domains,
            exclude_domains
          )
        }
...
async function searxngSearch(
  ...
  try {
    ...
    if (searchDepth === 'advanced') {
      ...
      url.searchParams.append('engines', 'Google Scholar,bing,duckduckgo,Scopus,sciencedirect,JSTOR,PubMed,arXiv,mwmbl,startpage,stract,swisscows,qwant')
    } else {
